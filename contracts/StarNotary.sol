...
contract StarNotary is ERC721 {
    ...
    string public constant name = "Marioken";
    ...
    function buyStar(uint256 _tokenId) public  payable {
        ...
        _transferFrom(ownerAddress, msg.sender, _tokenId); // We have to use _transferFrom
        address payable ownerAddressPayable = _make_payable(ownerAddress); // We need to make this to be able to use transfer() function
